package gen;// Generated from D:/mr/Compiler/Proj1/Jython/JythonCompiler/grammar\jython.g4 by ANTLR 4.10.1
...
public class jythonParser extends Parser {
	...
	public final ImportclassContext importclass() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(64);
			((ImportclassContext)_localctx).imprtedClass = match(CLASSNAME);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final VarDecContext varDec() throws RecognitionException {
		...
		try {
			...
			{
			setState(95);
			((VarDecContext)_localctx).type = _input.LT(1);
			_la = _input.LA(1);
			if ( !(_la==TYPE || _la==CLASSNAME) ) {
				((VarDecContext)_localctx).type = (Token)_errHandler.recoverInline(this);
			}
			else {
	...
	public final ArrayDecContext arrayDec() throws RecognitionException {
		...
		try {
			...
			{
			setState(98);
			((ArrayDecContext)_localctx).type = _input.LT(1);
			_la = _input.LA(1);
			if ( !(_la==TYPE || _la==CLASSNAME) ) {
				((ArrayDecContext)_localctx).type = (Token)_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				_errHandler.reportMatch(this);
			...
			match(T__8);
			setState(102);
			((ArrayDecContext)_localctx).name = match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MethodDecContext methodDec() throws RecognitionException {
		...
		try {
			...
			case CLASSNAME:
				{
				setState(105);
				((MethodDecContext)_localctx).type = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==TYPE || _la==CLASSNAME) ) {
					((MethodDecContext)_localctx).type = (Token)_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					_errHandler.reportMatch(this);
	...
	public final ConstructorContext constructor() throws RecognitionException {
		...
		try {
			...
			match(T__9);
			setState(128);
			((ConstructorContext)_localctx).type = _input.LT(1);
			_la = _input.LA(1);
			if ( !(_la==TYPE || _la==CLASSNAME) ) {
				((ConstructorContext)_localctx).type = (Token)_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
				_errHandler.reportMatch(this);
